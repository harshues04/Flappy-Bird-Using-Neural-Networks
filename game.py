...
class Pipe:
    BUFFER = 150
    DISTANCE = 250
    img = pygame.image.load("pipe-green.png")
...
class Bird:
    ...
    def __init__(self, initialY=SCREEN_HEIGHT//2, isYellow=False) -> None:
        self.isActive = True
        self.yVelocity = 0
        img = pygame.image.load("yellowbird-midflap.png").convert_alpha() if isYellow else pygame.image.load("bluebird-midflap.png").convert_alpha()
...
class FlappyBirdAIGame:
    ...
    speedImgs = (pygame.image.load("normal-speed.png"), pygame.image.load("medium-speed.png"), pygame.image.load("full-speed.png"))
    ...
    def __init__(self) -> None:
        ...
        ground = pygame.image.load("base.png").convert()
        self.ground = pygame.transform.scale2x(ground)
        pipe = pygame.image.load("pipe-green.png").convert()
